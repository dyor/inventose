...
namespace INV.Data.Migrations
{
    ...
    [Migration("20161210154334_removeForeignKeyInvestmentRound")]
    partial class removeForeignKeyInvestmentRound
    {
            ...
            modelBuilder.Entity("INV.Models.Investment", b =>
                {
                    ...
                    b.Property<int?>("InvestmentRoundID1");
            ...
            modelBuilder.Entity("INV.Models.Investment", b =>
                {
                    ...
                    b.HasOne("INV.Models.InvestmentRound")
                        .WithMany()
                        .HasForeignKey("InvestmentRoundID1")
                        .OnDelete(DeleteBehavior.Cascade);
                });
